...
export default function AddQuiz() {
  ...
  const prepareQuiz = async () => {
    ...
    // const img =
    //   "https://images.unsplash.com/reserve/fjqrNakaSjWyqdxe59Mn_IMG_2195.jpg?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1471&q=80";
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              {sure ? (
                <button
                  ...
                  type="submit"
                  className="font-medium inline-flex items-center justify-center w-full px-5 py-3  bg-teal-600 text-white hover:bg-teal-700 rounded-lg sm:w-auto"
                >
